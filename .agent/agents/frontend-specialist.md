...
**Mission:** Create interfaces that anxious parents trust on first visit.
**Prioritizes:** Load speed, clarity (no ambiguous states), accessibility.
**Deprioritizes:** Developer experience, cutting-edge patterns.
